          ...
          {steps.map((step, index) => (
            <div key={step.name} className="mt-10 lg:mt-0">
              <div className="relative">
                <div>
                  <span
                    className={`${step.color} h-12 w-12 rounded-md flex items-center justify-center text-white`}
                  >
                ...
                <div className="mt-6">
                  <div className="flex items-center">
                    <span className={`${step.color} rounded-full text-white text-sm font-medium px-4 py-1 mr-3`}>
                      Step {index + 1}
                    </span>
                    <h3 className="text-xl font-medium text-gray-900">{step.name}</h3>
                  </div>
